            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    <motion.div className="bg-white p-8 rounded-xl shadow-lg" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={staggerContainer}>
                        ...
                        <motion.div className="flex items-start space-x-4 mb-5" variants={fadeInUp}><FaEnvelope className="text-indigo-500 text-xl flex-shrink-0 mt-1" /><div><h4 className="text-lg font-medium text-gray-900">Email Address</h4><p className="text-gray-700">support@etuitionbd.com</p></div></motion.div>
                        <motion.div className="flex items-start space-x-4 mb-5" variants={fadeInUp}><FaPhoneAlt className="text-indigo-500 text-xl flex-shrink-0 mt-1" /><div><h4 className="text-lg font-medium text-gray-900">Phone/WhatsApp</h4><p className="text-gray-700">+8801761830425</p></div></motion.div>
                        <motion.div className="flex items-start space-x-4 mb-5" variants={fadeInUp}><FaMapMarkerAlt className="text-indigo-500 text-xl flex-shrink-0 mt-1" /><div><h4 className="text-lg font-medium text-gray-900">Office Location</h4><p className="text-gray-700">Chittagong, Bangladesh (Headquarters)</p></div></motion.div>
                        <hr className="my-6 border-gray-200" />
                        <h3 className="text-xl font-semibold text-gray-800 mb-4">Support Hours</h3>
                        <motion.div className="flex items-start space-x-4 mb-3" variants={fadeInUp}><FaCalendarAlt className="text-indigo-500 text-xl flex-shrink-0 mt-1" /><div><h4 className="text-lg font-medium text-gray-900">Working Days</h4><p className="text-gray-700">Saturday to Thursday (Friday Off)</p></div></motion.div>
                        <motion.div className="flex items-start space-x-4" variants={fadeInUp}><FaClock className="text-indigo-500 text-xl flex-shrink-0 mt-1" /><div><h4 className="text-lg font-medium text-gray-900">Timing</h4><p className="text-gray-700">9:00 AM - 6:00 PM (GMT+6)</p></div></motion.div>
                    </motion.div>
