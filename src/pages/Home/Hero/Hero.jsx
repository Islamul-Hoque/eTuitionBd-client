  ...
  return (
    <section className="bg-indigo-50 text-gray-800 min-h-[80vh] flex items-center px-6 md:px-16">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        {/* Right Side: Illustration (Mobile first: show on top) */}
        <motion.div
        ...
        >
          <img
            ...
            alt="Education Hero"
            className="w- 64 md:w-100 object-contain drop-shadow-xl"
          />
        </motion.div>
        ...
        >
          <motion.h1
            ...
            className="text-3xl md:text-5xl font-extrabold leading-tight text-indigo-600"
          >
            Find Verified Tutors & Trusted Tuition Posts
          </motion.h1>
          ...
          >
            eTuitionBd connects students and tutors with a seamless platform for learning, teaching, and growth.
          </motion.p>
