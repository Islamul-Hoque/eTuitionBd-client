...
const ForbiddenAccess = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-indigo-50 px-6">
      ...
      <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold text-indigo-500 mt-4">Forbidden Access (403)</h1>
      <p className="text-gray-600 mt-2 text-[1rem] sm:text-[1.2rem] md:text-[1.3rem] text-center"> You don’t have permission to view this page. </p>
